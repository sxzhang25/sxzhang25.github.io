...
- <b>Linearity:</b> If the players play multiple coalition games with characteristic functions $V_1, \ldots, V_m$, then the Shapley values satisfy $\varphi_i(V_1 + \cdots + V_m) = \varphi_i(V_1) + \cdots + \varphi_i(V_m)$. 
